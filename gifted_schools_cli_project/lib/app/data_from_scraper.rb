...
#           gifted_school.learning_profile = @learning_profile
#           gifted_school.city = @city 
#           gifted_school.name = @name
#           gifted_school.description = @description
#           gifted_school.more_info_url = @more_info_url
#           gifted_school.webpage = @webpage
#           gifted_school.type = @type
#           gifted_school.state = @state
#           gifted_school.grades = @grades
#         end
#     end
#   binding.pry
#   end
