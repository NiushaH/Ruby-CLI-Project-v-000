...
# Is this expression working for 'else'?  If not, why not???
    else
      self.display_schools_question
    end
  end
  ...
  def self.list_schools_alphabetically_by_name
  ...
  def self.list_schools_alphabetically_by_US_state
  ...
  def self.display_schools_by_name
    puts Rainbow("- - - - - - - - - - - - - - - - - - - - -").cyan
  ...
  def self.display_schools_by_US_state
    puts Rainbow("- - - - - - - - - - - - - - - - - - - - -").cyan
